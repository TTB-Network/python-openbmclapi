...
class TTBTable extends TTBElement {
    constructor(tag = "table", isElement = false) {
        super(tag, isElement)
        this.class("ttb-table")
        this._elementTitle = (new TTBElement("div")).class("ttb-table-title")
        ...
        this._headers = null
        this._data = null
        this.append(this._elementTitle, this._elementHeader, this._elementBody)
    }
    header(header) {
        this._headers = header
        this._elementHeader.getChildrens()[0].clear()
        console.log(this._elementHeader.getChildrens()[0])
    ...
    setData(...data) {
        ...
        for (const val of data) {
            ...
            if (Array.isArray(val)) {
                ...
                for (const key in Object.keys(this._headers)) element.getChildrens()[key].setHTML(val[Object.keys(this._headers)[key]])
            } else {
