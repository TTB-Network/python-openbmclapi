...
app.$Menu.add("dashboard", new class {
    ...
    async init() {
        ...
        this._r_ua = app.createFlex(true)
        this.geo_type = "world"
        ...
        this.pro = [
            ...
            app.createFlex(true).minWidth(1280).childWidths(60, 40).append(
                app.createElement("div").class("panel").append(
                    app.createElement("p").class("title").setI18N("dashboard.useragents"),
                    app.createFlex(true).childWidths(30, 70).append(
                        this._e_ua,
                        app.createElement("div").class("border-background").append(
                            this._r_ua
                        )
                    )
                ),
    ...
    drawGlobals() {
        ...
        var firstdata = data.slice(0, 5)
        var seconddata = data.slice(5, 10)
        var series = []
    ...
    setRank_UA() {
        ...
        var sd = data.slice(5, 10)
        var fdom = app.createElement("div").style("margin-right: 6px;")
        var sdom = app.createElement("div").style("margin-left:  6px;")
        for (var index in fd) {
            let value = fd[index]
            fdom.append(
                app.createElement("div").class("flex", "flex-space-between", "flex-aligns-center").style("margin-top: 8px; margin-bottom: 8px").append(
                    app.createElement("div").class("flex", "flex-aligns-center").append(
                        app.createElement("div").style(`background-color: var(--echarts-color-${index}); width: 10px; height: 10px; border-radius: 50%; margin-right: 8px`),
                        app.createElement("span").style("color: var(--title-color)").setText(value.label)
                    ),
        ...
        this._r_ua.append(fdom).child(1)
        if (sd.length != 0) {
            this._r_ua.append(sdom).child(2)
        }
        this._r_ua.update()
    }
    setStatus() {
