...
app.$Menu.add("dashboard", new class {
            ...
            app.createFlex(true).minWidth(1280).childWidths(70, 30).append(
                app.createElement("div").class("panel").append(
                    app.createElement("div").class("title", "flex-space-between", "flex-aligns-center").append(
                        app.createElement("span").style("color: var(--title-color)").setText("地理位置"),
                        this.switch_geo
                    ),
    ...
    drawGEO() {
        ...
        /*var data = this.global_stats.addresses.filter(e => this.geo_type == "china" && e.country == "CN" || this.geo_type == "world").map(e => {
            var name = $Country.filter(c => c.code == e.country)
            if (name.length == 0) name.push({
                code: '',
                name: '',
                name_en: ''
            })
            return {
                name: this.geo_type == "china" ? e.province : name[0].name_en,
                display_name: this.geo_type == "china" ? e.province : name[0].name,
                value: e.value
            }
        })
        data.sort((a, b) => b.value - a.value)*/
