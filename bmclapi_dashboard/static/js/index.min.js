...
app.$Menu.add("dashboard", new class {
    ...
    drawGlobals() {
        ...
        this.pro[0].getChildren()[2].getChildren()[1].setText(Object.values(visits).reduce((sum, i) => sum += i, 0) + "")
        var data = []
    ...
    setStatus() {
        ...
        if (this.pbar.valueOf().style.display == 'none' && this.status.progress != null) this.pbar_resize()
