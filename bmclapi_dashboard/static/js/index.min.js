...
class Console extends Element {
    ...
    log(timestamp, ...msg) {
        var messages = []
        var first = true;
        for (msg of [`[${formatDate(timestamp)}]`, ...msg]) {
...
app.$Menu.add("dashboard", new class {
    ...
    async init() {
        ...
        this._e_geo = app.createElement("div").class("value").style("min-height: 416px;")
        this.page = [
        ...
        this._e_hourly = {
            hits:    echarts.init(this.basic[1].getChildren()[0].getChildren()[1].valueOf()),
            bytes:   echarts.init(this.basic[1].getChildren()[1].getChildren()[1].valueOf())
        }
        this._e_daily = {
            hits:    echarts.init(this.basic[1].getChildren()[2].getChildren()[1].valueOf()),
            bytes:   echarts.init(this.basic[1].getChildren()[3].getChildren()[1].valueOf())
        }
        this._e_visits.setOption({"color":"#0fc6c2","darkMode":"auto","colorBy":"series","gradientColor":["#f6efa6","#d88273","#bf444c"],"aria":{"decal":{"decals":[{"color":"rgba(0, 0, 0, 0.2)","dashArrayX":[1,0],"dashArrayY":[2,5],"symbolSize":1,"rotation":0.5235987755982988},{"color":"rgba(0, 0, 0, 0.2)","symbol":"circle","dashArrayX":[[8,8],[0,8,8,0]],"dashArrayY":[6,0],"symbolSize":0.8},{"color":"rgba(0, 0, 0, 0.2)","dashArrayX":[1,0],"dashArrayY":[4,3],"rotation":-0.7853981633974483},{"color":"rgba(0, 0, 0, 0.2)","dashArrayX":[[6,6],[0,6,6,0]],"dashArrayY":[6,0]},{"color":"rgba(0, 0, 0, 0.2)","dashArrayX":[[1,0],[1,6]],"dashArrayY":[1,0,6,0],"rotation":0.7853981633974483},{"color":"rgba(0, 0, 0, 0.2)","symbol":"triangle","dashArrayX":[[9,9],[0,9,9,0]],"dashArrayY":[7,2],"symbolSize":0.75}]}},"textStyle":{"fontFamily":"Microsoft YaHei","fontSize":12,"fontStyle":"normal","fontWeight":"normal"},"stateAnimation":{"duration":300,"easing":"cubicOut"},"animation":"auto","animationDuration":1000,"animationDurationUpdate":500,"animationEasing":"cubicInOut","animationEasingUpdate":"cubicInOut","animationThreshold":2000,"progressiveThreshold":3000,"progressive":400,"hoverLayerThreshold":3000,"useUTC":false,"axisPointer":[{"show":"auto","z":50,"type":"line","snap":false,"triggerTooltip":true,"value":null,"status":null,"link":[],"animation":null,"animationDurationUpdate":200,"lineStyle":{"color":"#B9BEC9","width":1,"type":"dashed"},"shadowStyle":{"color":"rgba(210,219,238,0.2)"},"label":{"show":true,"formatter":null,"precision":"auto","margin":3,"color":"#fff","padding":[5,7,5,7],"backgroundColor":"auto","borderColor":null,"borderWidth":0,"borderRadius":3},"handle":{"show":false,"icon":"M10.7,11.9v-1.3H9.3v1.3c-4.9,0.3-8.8,4.4-8.8,9.4c0,5,3.9,9.1,8.8,9.4h1.3c4.9-0.3,8.8-4.4,8.8-9.4C19.5,16.3,15.6,12.2,10.7,11.9z M13.3,24.4H6.7v-1.2h6.6z M13.3,22H6.7v-1.2h6.6z M13.3,19.6H6.7v-1.2h6.6z","size":45,"margin":50,"color":"#333","shadowBlur":3,"shadowColor":"#aaa","shadowOffsetX":0,"shadowOffsetY":2,"throttle":40}}],"tooltip":[{"trigger":"axis","z":60,"show":true,"showContent":true,"triggerOn":"mousemove|click","alwaysShowContent":false,"displayMode":"single","renderMode":"auto","confine":null,"showDelay":0,"hideDelay":100,"transitionDuration":0.4,"enterable":false,"backgroundColor":"#fff","shadowBlur":10,"shadowColor":"rgba(0, 0, 0, .2)","shadowOffsetX":1,"shadowOffsetY":2,"borderRadius":4,"borderWidth":1,"padding":null,"extraCssText":"","axisPointer":{"type":"line","axis":"auto","animation":"auto","animationDurationUpdate":200,"animationEasingUpdate":"exponentialOut","crossStyle":{"color":"#999","width":1,"type":"dashed","textStyle":{}}},"textStyle":{"color":"#666","fontSize":14}}],"yAxis":[{"type":"value","splitLine":{"lineStyle":{"color":"#F8FAFC","width":1},"show":true},"boundaryGap":[0,0],"axisLine":{"show":"auto","onZero":true,"onZeroAxisIndex":null,"lineStyle":{"color":"#6E7079","width":1,"type":"solid"},"symbol":["none","none"],"symbolSize":[10,15]},"axisTick":{"show":"auto","inside":false,"length":5,"lineStyle":{"width":1}},"splitNumber":5,"minorTick":{"show":false,"splitNumber":5,"length":3,"lineStyle":{}},"minorSplitLine":{"show":false,"lineStyle":{"color":"#F4F7FD","width":1}},"show":true,"z":0,"inverse":false,"name":"","nameLocation":"end","nameRotate":null,"nameTruncate":{"maxWidth":null,"ellipsis":"...","placeholder":"."},"nameTextStyle":{},"nameGap":15,"silent":false,"triggerEvent":false,"tooltip":{"show":false},"axisPointer":{},"axisLabel":{"show":true,"inside":false,"rotate":0,"showMinLabel":null,"showMaxLabel":null,"margin":8,"fontSize":12},"splitArea":{"show":false,"areaStyle":{"color":["rgba(250,250,250,0.2)","rgba(210,219,238,0.2)"]}},"offset":0}],"xAxis":[{"type":"category","data":["2024-04-16 22:00","2024-04-16 23:00","2024-04-17 00:00","2024-04-17 01:00","2024-04-17 02:00","2024-04-17 03:00","2024-04-17 04:00","2024-04-17 05:00","2024-04-17 06:00","2024-04-17 07:00","2024-04-17 08:00","2024-04-17 09:00","2024-04-17 10:00","2024-04-17 11:00","2024-04-17 12:00","2024-04-17 13:00","2024-04-17 14:00","2024-04-17 15:00","2024-04-17 16:00","2024-04-17 17:00","2024-04-17 18:00","2024-04-17 19:00","2024-04-17 20:00","2024-04-17 21:00"],"axisTick":{"show":false,"alignWithLabel":false,"interval":"auto","inside":false,"length":5,"lineStyle":{"width":1}},"show":false,"boundaryGap":true,"deduplication":null,"splitLine":{"show":false,"lineStyle":{"color":["#E0E6F1"],"width":1,"type":"solid"}},"axisLabel":{"interval":"auto","show":true,"inside":false,"rotate":0,"showMinLabel":null,"showMaxLabel":null,"margin":8,"fontSize":12},"z":0,"inverse":false,"name":"","nameLocation":"end","nameRotate":null,"nameTruncate":{"maxWidth":null,"ellipsis":"...","placeholder":"."},"nameTextStyle":{},"nameGap":15,"silent":false,"triggerEvent":false,"tooltip":{"show":false},"axisPointer":{"status":"hide","value":13,"seriesDataIndices":[{"seriesIndex":0,"dataIndexInside":13,"dataIndex":13}]},"axisLine":{"show":true,"onZero":true,"onZeroAxisIndex":null,"lineStyle":{"color":"#6E7079","width":1,"type":"solid"},"symbol":["none","none"],"symbolSize":[10,15]},"splitArea":{"show":false,"areaStyle":{"color":["rgba(250,250,250,0.2)","rgba(210,219,238,0.2)"]}},"offset":0}],"grid":[{"top":5,"bottom":20,"right":0,"left":0,"show":false,"z":0,"containLabel":false,"backgroundColor":"rgba(0,0,0,0)","borderWidth":1,"borderColor":"#ccc"}],"series":[{"name":"访问情况","type":"line","symbol":"none","data":[178,22,53,17,19,107,93,6,6,1,27,131,27,3,13,468,35948,1785,2232,143,505,326,66,19],"smooth":true,"lineStyle":{"width":3,"color":{"type":"linear","x":0,"y":0,"x2":0,"y2":1,"global":false,"colorStops":[{"offset":0,"color":"#0FC6C2"},{"offset":1,"color":"#4260f0"}]},"type":"solid"},"itemStyle":{"borderRadius":[2,2,0,0]},"z":3,"coordinateSystem":"cartesian2d","legendHoverLink":true,"clip":true,"label":{"position":"top"},"endLabel":{"show":false,"valueAnimation":true,"distance":8},"emphasis":{"scale":true,"label":{}},"step":false,"smoothMonotone":null,"symbolSize":4,"symbolRotate":null,"showSymbol":true,"showAllSymbol":"auto","connectNulls":false,"sampling":"none","animationEasing":"linear","progressive":0,"hoverLayerThreshold":null,"universalTransition":{"divideShape":"clone"},"triggerLineEvent":false}],"visualMap":[],"legend":[],"markArea":[],"markLine":[],"markPoint":[],"brush":[],"dataZoom":[]})
        this.initGlobals()
        this.initPro()
    ...
    initGlobals() {
        var option = {
            tooltip: {
                trigger: 'axis',
                //formatter: e => '<div style="margin: 0px 0 0;line-height:1;"><div style="margin: 0px 0 0;line-height:1;"><div style="font-size:14px;color:#666;font-weight:400;line-height:1;">' + e[0].name + '</div><div style="margin: 10px 0 0;line-height:1;"><div style="margin: 0px 0 0;line-height:1;"><div style="margin: 0px 0 0;line-height:1;"><span style="display:inline-block;margin-right:4px;border-radius:10px;width:10px;height:10px;background-color:' + e[0].color + ';"></span><span style="font-size:14px;color:#666;font-weight:400;margin-left:2px">QPS</span><span style="float:right;margin-left:20px;font-size:14px;color:#666;font-weight:900">Avg: ' + (e[0].data / 5) + " total: " + e[0].data + '</span><div style="clear:both"></div></div><div style="clear:both"></div></div><div style="clear:both"></div></div><div style="clear:both"></div></div><div style="clear:both"></div></div>',
            },
            stateAnimation: {
                duration: 300,
                easing: "cubicOut"
