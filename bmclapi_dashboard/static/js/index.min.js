...
app.$Menu.add("dashboard", new class {
    ...
    clearBasic() {
        ...
        this.basic[1].getChildren()[0].getChildren()[0].getChildren()[1].t18n({peer: 0})
        this.basic[1].getChildren()[1].getChildren()[0].getChildren()[1].t18n({peer: 0})
        this.basic[1].getChildren()[2].getChildren()[0].getChildren()[1].t18n({peer: 0})
        this.basic[1].getChildren()[3].getChildren()[0].getChildren()[1].t18n({peer: 0})
        for (var e of [this._e_hourly, this._e_daily]) {
            for (var o of Object.values(e)) {
                o.clear()
            }
