...
class TemplateEchart extends Element {
    ...
    _e_templates(params) {
        ...
        return `<div style="margin: 0px 0 0;line-height:1;"><div style="margin: 0px 0 0;line-height:1;"><div style="font-size:14px;color:#666;font-weight:400;line-height:1;">${(Array.isArray(params) ? params[0] : params).name}</div><div style="margin: 10px 0 0;line-height:1;">${template}</div><div style="clear:both"></div></div><div style="clear:both"></div></div>`
    }
    getOption() {
...
$I18N.addLangs("zh_cn", {
    ...
    "dashboard.in30days.requests": "今日下载数",
    "dashboard.in30days.filebytes": "今日下载量",
    "dashboard.connections": "连接数",
    "dashboard.memory": "内存情况",
    "dashboard.file_cache": "文件缓存情况",
    "dashboard.in5mins.load": "5 分钟负载",
    "dashboard.in5mins.requests": "5 分钟请求数 - %count%",
...
app.$Menu.add("dashboard", new class {
    ...
    async init() {
        ...
        this.geo_type = "world"
        this.switch_geo = (new ElementSwitch("世界", "中国")).style("border: 1px solid var(--border-color);").event("click", (index) => {
        ...
        this.page = [
            ...
            app.createFlex().minWidth(1148).childWidths(60, 40).append(
                app.createElement("div").append(
                    app.createElement("div").class("panel").append(
                ...
                app.createElement("div").class("panel").append(
                    app.createElement("p").class("title").setI18N("dashboard.in5mins.requests", {count: "-"}),
                    this._be_qps
                )
            ),
            app.createFlex().child(2).append(
                app.createElement("div").class("panel").append(
                    app.createElement("p").class("title").setI18N("dashboard.download.hourly"),
                    this._e_hourly.hits
                ),
                app.createElement("div").class("panel").append(
                    app.createElement("p").class("title").setI18N("dashboard.bytes.hourly"),
                    this._e_hourly.bytes
                ),
                app.createElement("div").class("panel").append(
                    app.createElement("p").class("title").setI18N("dashboard.download.daily"),
                    this._e_daily.hits
                ),
                app.createElement("div").class("panel").append(
                    app.createElement("p").class("title").setI18N("dashboard.bytes.daily"),
                    this._e_daily.bytes
                )
    ...
    clear() {
        ...
        this._be_qps.clear()
        this._pe_qps.clear()
        this.basic[0].getChildren()[1].getChildren()[0].t18n({ count: "-" })
        this.pro[0].getChildren()[1].getChildren()[1].getChildren()[0].t18n({ count: "-" })
    }
    ...
    drawQPS() {
        try {
            ...
            this.basic[0].getChildren()[1].getChildren()[0].t18n({ count: count })
            this.pro[0].getChildren()[1].getChildren()[1].getChildren()[0].t18n({ count: count })
        } catch (e) {
        }
    }
    drawGEO() {
        if (this.global_stats == null) return
        var data = []
        if (this.geo_type == "world") {
            var other = []
            var cn_data = 0
            this.global_stats.addresses.forEach(e => {
            ...
            data = this.global_stats.addresses.filter(e => e.country == "CN").map(e => {
                return {
                    name: e.province,
    ...
    drawSystem() {
        ...
        this.page[1].getChildren()[0].getChildren()[0].getChildren()[0].getChildren()[0].getChildren()[1].setText(this._format_number_unit(hits))
        this.page[1].getChildren()[0].getChildren()[0].getChildren()[0].getChildren()[1].getChildren()[1].setText(this._format_bytes(bytes))
        ...
        this.page[1].getChildren()[0].getChildren()[0].getChildren()[0].getChildren()[2].getChildren()[1].setText(this._format_number_unit(hits))
        this.page[1].getChildren()[0].getChildren()[0].getChildren()[0].getChildren()[3].getChildren()[1].setText(this._format_bytes(bytes))
    ...
    drawGlobals() {
        var visits = fillDates(this.global_stats.distinct_ip) 
        this._e_visits.setOption({
            xAxis: {
