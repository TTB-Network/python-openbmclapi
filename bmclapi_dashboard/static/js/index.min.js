...
class Application {
    constructor() {
        ...
        this.$header = this.createElement("header").append(
            ...
            this.createElement("div").class("content").append(
                this.createElement("button").setHTML('<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M12 22q-2.05 0-3.875-.788t-3.187-2.15q-1.363-1.362-2.15-3.187T2 12q0-2.075.788-3.887t2.15-3.175Q6.3 3.575 8.124 2.788T12 2q2.075 0 3.888.788t3.174 2.15q1.363 1.362 2.15 3.175T22 12q0 2.05-.788 3.875t-2.15 3.188q-1.362 1.362-3.175 2.15T12 22m0-2.05q.65-.9 1.125-1.875T13.9 16h-3.8q.3 1.1.775 2.075T12 19.95m-2.6-.4q-.45-.825-.787-1.713T8.05 16H5.1q.725 1.25 1.813 2.175T9.4 19.55m5.2 0q1.4-.45 2.488-1.375T18.9 16h-2.95q-.225.95-.562 1.838T14.6 19.55M4.25 14h3.4q-.075-.5-.112-.987T7.5 12q0-.525.038-1.012T7.65 10h-3.4q-.125.5-.187.988T4 12q0 .525.063 1.013T4.25 14m5.4 0h4.7q.075-.5.113-.987T14.5 12q0-.525-.038-1.012T14.35 10h-4.7q-.075.5-.112.988T9.5 12q0 .525.038 1.013T9.65 14m6.7 0h3.4q.125-.5.188-.987T20 12q0-.525-.062-1.012T19.75 10h-3.4q.075.5.113.988T16.5 12q0 .525-.038 1.013T16.35 14m-.4-6h2.95q-.725-1.25-1.812-2.175T14.6 4.45q.45.825.788 1.713T15.95 8M10.1 8h3.8q-.3-1.1-.775-2.075T12 4.05q-.65.9-1.125 1.875T10.1 8m-5 0h2.95q.225-.95.563-1.838T9.4 4.45Q8 4.9 6.912 5.825T5.1 8"/></svg>'),
    ...
    updateData() {
        ...
        for (const val of data) {
            ...
            const progress = app.createElement("div").class("app-rank-progressbar").append(
                app.createElement("div").class("app-rank-progressbar-value").style(`width: ${total == 0 ? 0 : (val.value / total) * 100.0}%`)
            )
            const text = app.createElement("div").class("app-rank-text").append(
                app.createElement("p").class("normal").setText(val.name),
    ...
    _e_templates(params) {
        ...
        if (Array.isArray(params)) {
            for (const data of params) {
                ...
                template += templates.replace("{color}", data.color).replace("{name}", data.seriesName).replace("{value}", value_formatter ? value_formatter(value) : value)
            }
        } else {
            const data = params
            let value = isNaN(data.value) ? 0 : data.value
...
app.$Menu.add("dashboard", new class {
    ...
    async init() {
        ...
        this.switch_pro_day = (new ElementSwitch("dashboard.last.day.1", "dashboard.last.day.7", "dashboard.last.day.30")).event("click", (index) => {
            this.data_day_option = index
            if (this.get_globals_stats) {
                $progress.set(60)
                $MainSocket.send("pro_stats", this.data_day_option).then((data) => {
                    $progress.set(90)
                    this.pro_stats = data
                    this.drawGlobals()
                    this.drawGEO()
        ...
        this._e_ua = app.createEcharts().style("min-height: 140px").setOption({"color":["#0FC6C2","#6199FE","#FFD268","#FF5576","#89DFE2"],"darkMode":"auto","colorBy":"series","gradientColor":["#f6efa6","#d88273","#bf444c"],"aria":{"decal":{"decals":[{"color":"rgba(0, 0, 0, 0.2)","dashArrayX":[1,0],"dashArrayY":[2,5],"symbolSize":1,"rotation":0.5235987755982988},{"color":"rgba(0, 0, 0, 0.2)","symbol":"circle","dashArrayX":[[8,8],[0,8,8,0]],"dashArrayY":[6,0],"symbolSize":0.8},{"color":"rgba(0, 0, 0, 0.2)","dashArrayX":[1,0],"dashArrayY":[4,3],"rotation":-0.7853981633974483},{"color":"rgba(0, 0, 0, 0.2)","dashArrayX":[[6,6],[0,6,6,0]],"dashArrayY":[6,0]},{"color":"rgba(0, 0, 0, 0.2)","dashArrayX":[[1,0],[1,6]],"dashArrayY":[1,0,6,0],"rotation":0.7853981633974483},{"color":"rgba(0, 0, 0, 0.2)","symbol":"triangle","dashArrayX":[[9,9],[0,9,9,0]],"dashArrayY":[7,2],"symbolSize":0.75}]}},"textStyle":{"fontFamily":"Microsoft YaHei","fontSize":12,"fontStyle":"normal","fontWeight":"normal"},"stateAnimation":{"duration":300,"easing":"cubicOut"},"animation":"auto","animationDuration":1000,"animationDurationUpdate":500,"animationEasing":"cubicInOut","animationEasingUpdate":"cubicInOut","animationThreshold":2000,"progressiveThreshold":3000,"progressive":400,"hoverLayerThreshold":3000,"useUTC":false,"axisPointer":[{"show":"auto","z":50,"type":"line","snap":false,"triggerTooltip":true,"value":null,"status":null,"link":[],"animation":null,"animationDurationUpdate":200,"lineStyle":{"color":"#B9BEC9","width":1,"type":"dashed"},"shadowStyle":{"color":"rgba(210,219,238,0.2)"},"label":{"show":true,"formatter":null,"precision":"auto","margin":3,"color":"#fff","padding":[5,7,5,7],"backgroundColor":"auto","borderColor":null,"borderWidth":0,"borderRadius":3},"handle":{"show":false,"icon":"M10.7,11.9v-1.3H9.3v1.3c-4.9,0.3-8.8,4.4-8.8,9.4c0,5,3.9,9.1,8.8,9.4h1.3c4.9-0.3,8.8-4.4,8.8-9.4C19.5,16.3,15.6,12.2,10.7,11.9z M13.3,24.4H6.7v-1.2h6.6z M13.3,22H6.7v-1.2h6.6z M13.3,19.6H6.7v-1.2h6.6z","size":45,"margin":50,"color":"#333","shadowBlur":3,"shadowColor":"#aaa","shadowOffsetX":0,"shadowOffsetY":2,"throttle":40}}],"tooltip":[{"trigger":"item","z":60,"show":true,"showContent":true,"triggerOn":"mousemove|click","alwaysShowContent":false,"displayMode":"single","renderMode":"auto","confine":null,"showDelay":0,"hideDelay":100,"transitionDuration":0.4,"enterable":false,"backgroundColor":"#fff","shadowBlur":10,"shadowColor":"rgba(0, 0, 0, .2)","shadowOffsetX":1,"shadowOffsetY":2,"borderRadius":4,"borderWidth":1,"padding":null,"extraCssText":"","axisPointer":{"type":"line","axis":"auto","animation":"auto","animationDurationUpdate":200,"animationEasingUpdate":"exponentialOut","crossStyle":{"color":"#999","width":1,"type":"dashed","textStyle":{}}},"textStyle":{"color":"#666","fontSize":14}}],"series":[{"name":"客户端","type":"pie","radius":["30%","45%"],"label":{"position":"inner","fontSize":14,"rotate":0,"show":true,"overflow":"truncate","alignTo":"none","edgeDistance":"25%","bleedMargin":10,"distanceToLabelLine":5},"labelLine":{"show":false,"length":15,"length2":15,"smooth":false,"minTurnAngle":90,"maxSurfaceAngle":90,"lineStyle":{"width":1,"type":"solid"}},"data":[{"label":"macOS","value":98190,"emphasis":{"label":{}}},{"label":"Windows","value":18870,"emphasis":{"label":{}}},{"label":"Linux","value":3762,"emphasis":{"label":{}}},{"label":"ChromeOS","value":548,"emphasis":{"label":{}}},{"label":"Android","value":65,"emphasis":{"label":{}}}],"tooltip":{},"minAngle":10,"minShowLabelAngle":1,"itemStyle":{"borderRadius":2,"borderWidth":2,"borderColor":"#fff","borderJoin":"round"},"z":2,"legendHoverLink":true,"colorBy":"data","center":["50%","50%"],"clockwise":true,"startAngle":90,"selectedOffset":10,"percentPrecision":2,"stillShowZeroSum":true,"left":0,"top":0,"right":0,"bottom":0,"width":null,"height":null,"showEmptyCircle":true,"emptyCircleStyle":{"color":"lightgray","opacity":1},"labelLayout":{"hideOverlap":true},"emphasis":{"scale":true,"scaleSize":5,"label":{"show":true},"labelLine":{"show":false}},"avoidLabelOverlap":true,"animationType":"expansion","animationDuration":1000,"animationTypeUpdate":"transition","animationEasingUpdate":"cubicInOut","animationDurationUpdate":500,"animationEasing":"cubicInOut"},{"name":"浏览器","type":"pie","radius":["65%","80%"],"label":{"show":false,"rotate":0,"overflow":"truncate","position":"outer","alignTo":"none","edgeDistance":"25%","bleedMargin":10,"distanceToLabelLine":5},"itemStyle":{"borderRadius":2,"borderWidth":2,"borderColor":"#fff","borderJoin":"round"},"data":[{"label":"Chrome","value":93137,"emphasis":{"label":{}}},{"label":"Firefox","value":11776,"emphasis":{"label":{}}},{"label":"Edge","value":6950,"emphasis":{"label":{}}},{"label":"Safari","value":6924,"emphasis":{"label":{}}},{"label":"ANCHASHI-SCAN","value":2653,"emphasis":{"label":{}}}],"minAngle":10,"minShowLabelAngle":1,"tooltip":{},"z":2,"legendHoverLink":true,"colorBy":"data","center":["50%","50%"],"clockwise":true,"startAngle":90,"selectedOffset":10,"percentPrecision":2,"stillShowZeroSum":true,"left":0,"top":0,"right":0,"bottom":0,"width":null,"height":null,"labelLine":{"show":false,"length":15,"length2":15,"smooth":false,"minTurnAngle":90,"maxSurfaceAngle":90,"lineStyle":{"width":1,"type":"solid"}},"showEmptyCircle":true,"emptyCircleStyle":{"color":"lightgray","opacity":1},"labelLayout":{"hideOverlap":true},"emphasis":{"scale":true,"scaleSize":5,"label":{"show":false},"labelLine":{"show":false}},"avoidLabelOverlap":true,"animationType":"expansion","animationDuration":1000,"animationTypeUpdate":"transition","animationEasingUpdate":"cubicInOut","animationDurationUpdate":500,"animationEasing":"cubicInOut"}],"visualMap":[],"legend":[],"markArea":[],"markLine":[],"markPoint":[],"brush":[],"dataZoom":[]})
        this.geo_type = "world"
        ...
        this.basic = [
                ...
                app.createElement("div").class("panel").append(
                    app.createElement("p").class("title", "flex-space-between").append(
                        app.createElement("span").class("flex").append(
                            app.createElement("p").style("color: var(--title-color)").setI18N("dashboard.in5mins.requests"),
                        ...
                        app.createElement("div").class("flex", "flex-align-items").append(
            ...
            app.createFlex(true).child(2).append(
                app.createElement("div").class("panel").append(
                    app.createElement("p").class("title", "flex-space-between").append(
                        app.createElement("span").style("color: var(--title-color)").setI18N("dashboard.download.hourly"),
                        app.createElement("span").style("color: var(--title-color)").setI18N("dashboard.peer")
                    ),
                    this._e_hourly.hits
                ),
                app.createElement("div").class("panel").append(
                    app.createElement("p").class("title", "flex-space-between").append(
                        app.createElement("span").style("color: var(--title-color)").setI18N("dashboard.bytes.hourly"),
                        app.createElement("span").style("color: var(--title-color)").setI18N("dashboard.peer")
                    ),
                ...
                app.createElement("div").class("panel").append(
                    app.createElement("p").class("title", "flex-space-between").append(
                        app.createElement("span").style("color: var(--title-color)").setI18N("dashboard.download.daily"),
                        app.createElement("span").style("color: var(--title-color)").setI18N("dashboard.peer")
                    ),
                    this._e_daily.hits
                ),
                app.createElement("div").class("panel").append(
                    app.createElement("p").class("title", "flex-space-between").append(
                        app.createElement("span").style("color: var(--title-color)").setI18N("dashboard.bytes.daily"),
                        app.createElement("span").style("color: var(--title-color)").setI18N("dashboard.peer")
                    ),
                    this._e_daily.bytes
                )
            ...
            app.createFlex(true).minWidth(1280).childWidths(70, 30).append(
                app.createElement("div").class("panel").append(
                    app.createElement("div").class("title", "flex-space-between", "flex-aligns-center").append(
                        app.createElement("span").style("color: var(--title-color)").setI18N("dashboard.geo"),
                        this.switch_geo
                    ),
                ...
                app.createElement("div").append(
                    app.createElement("div").class("panel").append(
                        app.createElement("p").class("title", "flex-space-between").append(
                            app.createElement("span").style("color: var(--title-color)").setI18N("dashboard.distincts"),
                            app.createElement("span").style("color: var(--title-color)").setI18N("dashboard.peer", { peer: "-" }),
                        ),
                        this._e_visits
                    ),
                    app.createElement("div").class("panel").append(
                ...
                this.pgeorank.update(false)
                setTimeout(() => this._e_geo.resize(), 50)
                this._pe_qps.resize()
                this._e_visits.resize()
            }),
            app.createFlex(true).minWidth(1280).childWidths(60, 40).append(
                app.createElement("div").class("panel").append(
                    app.createElement("p").class("title").setText("dashboard.useragents"),
                    app.createFlex(true).child(2).append(
                        this._e_ua,
                        app.createElement("div").class("stats")
                    )
                ),
                app.createElement("div").class("panel").append(
                    app.createElement("p").class("title").setText("dashboard.storages"),
                ),
            ).addResize(() => {
                this._e_ua.resize()
            })
    ...
    clearPro() {
        ...
        this.pro[0].getChildren()[1].getChildren()[0].getChildren()[0].getChildren()[1].t18n({ peer: "-" })
    }
    clearBasic() {
        this.systemTimer?.block()
    ...
    clear() {
        ...
        this.pro[0].getChildren()[1].getChildren()[1].getChildren()[0].getChildren()[0].getChildren()[1].getChildren()[1].setText("0")
    }
    ...
    drawQPS() {
        try {
            ...
            this.pro[0].getChildren()[1].getChildren()[1].getChildren()[0].getChildren()[0].getChildren()[1].getChildren()[1].setText(count)
        } catch (e) {
        }
    }
    drawGEO() {
    ...
    drawGlobals() {
        var visits = fillDates(this.pro_stats.distinct_ip)
        this._e_visits.setOption({
            xAxis: {
        ...
        this.pro[0].getChildren()[1].getChildren()[0].getChildren()[0].getChildren()[1].t18n({ peer: Math.max(...Object.values(visits)) })
    }
    setStatus() {
