...
class Application {
    constructor() {
        ...
        this.$footer = this.createElement("footer").append(
            this.createElement("p").append(
                this.createElement("span").setText("由 "),
                this.createElement("a").setText("2b2ttianxiu").setAttribute("href", "//github.com/tianxiu2b2t"),
                this.createElement("spawn").setText(" 制作",)
            )
        )
