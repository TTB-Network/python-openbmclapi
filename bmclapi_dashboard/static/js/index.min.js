...
app.$Menu.add("dashboard", new class {
    ...
    async init() {
        ...
        this.e_bqps = app.createElement("div").class("value").style("min-height: 162px;")
        this.e_pqps = app.createElement("div").class("value").style("min-height: 162px;")
        ...
        this.pro = [
            app.createFlex(true).minWidth(1148).childWidths(70, 30).append(
                ...
                app.createElement("div").append(
                    app.createElement("div").class("panel").append(
                        app.createElement("p").class("title").setText("dashboard.in5mins.requests", {count: "-"}),
                        app.createElement("div").class("value").style("min-height: 162px;")
                    ),
                    app.createElement("div").class("panel").append(
                        app.createElement("p").class("title").setText("dashboard.in5mins.requests", {count: "-"}),
                        this.e_pqps
        ...
        this._e_visits = echarts.init(this.pro[0].getChildren()[1].getChildren()[0].getChildren()[1].valueOf())
        this._be_qps = echarts.init(this.e_bqps.valueOf())
        this._pe_qps = echarts.init(this.e_pqps.valueOf())
        this.initGlobals()
        this.initPro()
