...
app.$Menu.add("dashboard", new class {
    ...
    async init() {
        ...
        this.pro = [
            app.createFlex(true).class("panel").minWidth(640).child(3).append(
                ...
                app.createElement("div").append(
                    app.createElement("p").class("title").setI18N("dashboard.pro.useragents"),
                    app.createElement("p").class("value").setText("dashboard.storages"),
                )
            ).update(),
    ...
    drawGlobals() {
        ...
        //this.pro[0].getChildren()[1].getChildren()[2].setText(Object.values(visits).reduce((sum, i) => sum += i, 0) + "")
        var data = []
