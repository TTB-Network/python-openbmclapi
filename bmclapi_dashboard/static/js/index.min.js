...
app.$Menu.add("dashboard", new class {
    ...
    async init() {
        ...
        this._e_hourly = {
            hits:    echarts.init(this.page[2].getChildren()[0].getChildren()[1].valueOf()),
            bytes:   echarts.init(this.page[2].getChildren()[1].getChildren()[1].valueOf())
        }
        this._e_daily = {
            hits:    echarts.init(this.page[2].getChildren()[2].getChildren()[1].valueOf()),
            bytes:   echarts.init(this.page[2].getChildren()[3].getChildren()[1].valueOf())
        }
        this._e_qps = echarts.init(this.page[1].getChildren()[1].getChildren()[1].valueOf())
    ...
    drawQPS() {
        this._e_qps.setOption({
            ...
            series: [{data: Object.values(this.qps)}]
        })
    }
    drawSystem() {
        var hits, bytes;
        ...
        this.page[1].getChildren()[0].getChildren()[1].getChildren()[0].getChildren()[0].getChildren()[1].setText(this._format_number_unit(this.system.connections))
        this.page[1].getChildren()[0].getChildren()[1].getChildren()[0].getChildren()[1].getChildren()[1].setText(this._format_bytes(this.system.memory))
        this.page[1].getChildren()[0].getChildren()[1].getChildren()[0].getChildren()[2].getChildren()[1].getChildren()[0].setText(this._format_number_unit(this.system.cache.total))
        this.page[1].getChildren()[0].getChildren()[1].getChildren()[0].getChildren()[2].getChildren()[1].getChildren()[1].setText(`(${this._format_bytes(this.system.cache.bytes)})`)
        this.page[1].getChildren()[0].getChildren()[1].getChildren()[0].getChildren()[3].getChildren()[1].setText(this.system.cpu.toFixed(2) + "%")
    }
    setStatus() {
