...
const fillDateTimes = (dates) => {
    ...
    for (let i = Object.keys(filledDates).length; i < 24; i++) {
        filledDates[formatDateTime(new Date(latestDate + (i - 24) * 3600000))] = 0
    }
    return { ...filledDates, ...dates };
}
$github = (() => {
...
app.$Menu.add("dashboard", new class {
    ...
    drawGlobals() {
        var visits = fillDateTimes(this.pro_stats.distinct_ip)
        this._e_visits.setOption({
            xAxis: {
