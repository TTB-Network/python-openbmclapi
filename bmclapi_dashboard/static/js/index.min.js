    ...
    async init() {
        ...
        this.pro = [
            app.createFlex(true).class("panel").minWidth(640).child(3).append(
                app.createElement("div").append(
                    app.createElement("p").class("title").i18n("dashboard.pro.access"),
                    app.createElement("p").class("value").setText("dashboard.storages"),
                ),
                app.createElement("div").append(
                    app.createElement("p").class("title").i18n("dashboard.pro.distincts"),
                    app.createElement("p").class("value").setText("dashboard.storages"),
                ),
                app.createElement("div").append(
                    app.createElement("p").class("title").i18n("dashboard.pro.useragents"),
                    app.createElement("p").class("value").setText("dashboard.storages"),
                )
            ).update(),
